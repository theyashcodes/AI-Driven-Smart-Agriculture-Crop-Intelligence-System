...
class User(Base):
    """Platform operator or client identity representation"""
    __tablename__ = "users"
...
class Farm(Base):
    """Agricultural zone collection mapped to user"""
    __tablename__ = "farms"
    id = Column(Integer, primary_key=True, index=True)
...
class Field(Base):
    """Sub-sector tracking specific crop lifecycles"""
...
class Alert(Base):
    """System-generated warnings based on telemetry bounds"""
